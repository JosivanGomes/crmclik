 ...
 <body>
   ...
   <!--TELA PRINCIPAL-->
     ...
     <?php
       ...
       $con = mysqli_connect("localhost", "root", "", "crmclik");
       $sql = mysqli_query($con, "SELECT * FROM proposta WHERE id_bkoPend = '{$vendedor}' AND situacao = 'TRATAMENTO INSTALACAO'") or print mysql_error();
       ...
       echo "<h4>Geral:</h4>";
       $mes = date('Y/m/d');
       $sql = mysqli_query($con, "SELECT * FROM proposta WHERE data_instalacao <= '$mes' and situacao = 'APROVADO'") or print mysql_error();
       $linha = mysqli_fetch_array($sql);
