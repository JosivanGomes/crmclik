 ...
 <body>
   ...
   <header>
     <nav class="navbar navbar-expand-lg">
       <a class="navbar-brand">
         ...
         <p style="margin-right: 455px;">Cli-K</p>
       </a>
         ...
         <ul class="navbar-nav">
           ...
           <li class="nav-item">
             <a class="nav-link text-truncate" href="posinstalacao.php">Pós Instalação</a>
           </li>
   ...
   <?php
     ...
     if(mysqli_num_rows($sql)>0):
       ...
       echo   "<th scope=\"col\">Situação Contrato</th>";
       ...
       do {
         ...
         $idVenda = $linha["id"];
           ...
           echo"<td>
                  <select id=\"status$idVenda\" onblur=\"liberaCampo$idVenda()\">
                    <option></option>
                    <option>ATIVO</option>
                ...
                echo "<div id=\"dtT$idVenda\">";

                $dtVendaInst = $linha["data_instalacao"];
                if(empty($dtVendaInst)):
                  echo   "<td>$dtVendaInst</td>";
                else:
                  $newDateInst = date("d/m/Y", strtotime($dtVendaInst));
                  echo   "<td>$newDateInst</td>";
                endif;
          ...
          <td><button type=\"button\" class=\"btn btn-outline-primary\" data-toggle=\"modal\" data-target=\"#modal$idVenda\">Ver/Atualizar</button></td>
          ...
          ";
           ...
           echo "<!-- Modal -->
                ...
                <script>
                  ...
                  function liberaCampo$idVenda(){
                      alert(document.getElementById('status$idVenda').innerHTML)
                      alert(document.getElementById('status$idVenda').innerHTML)
