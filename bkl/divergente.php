...
<html lang="pt-br">
 ...
 <body>
   ...
   <!--TELA PRINCIPAL-->
     ...
     $sql = mysqli_query($connect, "SELECT * FROM proposta WHERE id_bkoPend = '{$vendedor}' AND situacao = 'TRATAMENTO DIVERGENTE'") or print mysql_error();
     ...
     $sql = mysqli_query($connect, "SELECT * FROM proposta WHERE id_bkoPend = '{$vendedor}' AND situacao = 'TRATAMENTO BACKLOG'") or print mysql_error();
     $linha = mysqli_fetch_array($sql);
     ...
     if(mysqli_num_rows($sql)>0):
       ...
       echo "<h4>Geral:</h4>";
       $mes = date('m');
       $sql = mysqli_query($connect, "SELECT * FROM proposta WHERE MONTH(data_instalacao) = '$mes' and situacao = 'APROVADO DIVERGENTE' OR situacao = 'BACKLOG'") or print mysql_error();
       $linha = mysqli_fetch_array($sql);
