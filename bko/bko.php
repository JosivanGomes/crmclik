 ...
 <body>
   ...
   <!--TELA PRINCIPAL-->
     ...
     <?php
       ...
       $sql = mysqli_query($connect, "SELECT * FROM proposta WHERE id_bko = '{$vendedor}' AND situacao = 'EM TRATAMENTO' AND id_bkoPend = 0") or print mysql_error();
       ...
       $sql = mysqli_query($connect, "SELECT * FROM proposta WHERE situacao = 'CADASTRO OK' OR situacao = 'SEM CONTATO'") or print mysql_error();
       $linha = mysqli_fetch_array($sql);
